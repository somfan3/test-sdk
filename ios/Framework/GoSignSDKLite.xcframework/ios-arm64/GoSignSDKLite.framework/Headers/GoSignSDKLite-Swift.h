...
@interface API (SWIFT_EXTENSION(GoSignSDKLite))
+ (void)registerDeviceWithToken:(NSString * _Nonnull)authenToken localizedReason:(NSString * _Nonnull)localizedReason completion:(void (^ _Nonnull)(RegisterDeviceAPIResponse * _Nullable, NSError * _Nullable))completion;
+ (void)authoriseaPendingRequestWithToken:(NSString * _Nonnull)authenToken localizedReason:(NSString * _Nonnull)localizedReason pendingAuthorisationAPIResponse:(PendingAuthorisationAPIResponse * _Nonnull)pendingAuthorisationAPIResponse completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
@end
